            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        editable=False,
                        help_text="An identifier that is a hash of the name. It's created from the slug of the name when the model is saved. It's useful to avoid exposing the internal PK to the public.",
                        max_length=16,
                        unique=True,
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        help_text="Name of the source. Must be unique.", max_length=200, unique=True
                    ),
                ),
                (
                    "description",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        editable=False,
                        help_text="An identifier that is a hash of: `slugify(self.statement)+self.debate.identifier+self.author.identifier`. It's created when the model is saved. It's useful to avoid exposing the internal PK to the public.",
                        max_length=16,
                        unique=True,
                    ),
                ),
